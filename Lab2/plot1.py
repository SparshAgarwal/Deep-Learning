...
e = [x for x in range(0, 1500)]

train[0] = [float(x[18:]) * 100 for x in train[0][:1500]]
tune[0] = [float(x[18:]) * 100 for x in tune[0][:1500]]
test[0] = [float(x[18:]) * 100 for x in test[0][:1500]]
train[1] = [float(x[19:]) * 100 for x in train[1][:1500]]
tune[1] = [float(x[19:]) * 100 for x in tune[1][:1500]]
test[1] = [float(x[19:]) * 100 for x in test[1][:1500]]
train[2] = [float(x[18:]) * 100 for x in train[2][:1500]]
tune[2] = [float(x[18:]) * 100 for x in tune[2][:1500]]
test[2] = [float(x[18:]) * 100 for x in test[2][:1500]]
train[3] = [float(x[18:]) * 100 for x in train[3][:1500]]
tune[3] = [float(x[18:]) * 100 for x in tune[3][:1500]]
test[3] = [float(x[18:]) * 100 for x in test[3][:1500]]
